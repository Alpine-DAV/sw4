...
#pragma omp parallel for reduction(+:material,outside)
		...
		if( inside( x, y, z ) ) {
		   ...
		   if( k0 >= m_klast[gr]-1 ) 
   		   ...
   		   // bilinear intp.
                   ...
                   // Tang debug
                   /* if (g == 1 && z < 21 && z > -21 && cp[g](i, j, k) > 2800) { */
                   /*   float_sw4 tmp_z = (k0-1)*hv+z0; */
                   /*   if (k0 > m_kfirst[gr]) */ 
                   /*       printf("Rank %d: Grid %d, (%d, %d, %d) z = %.2f, goes to patch %d (%d, %d, %d) z = %.2f, p = %.2f, " */
                   /*              "mat_p = %.2f, mat_p below = %.2f\n", */ 
                   /*               mEW->getRank(), g, i, j, k, z, gr, i0, j0, k0, tmp_z, cp[g](i, j, k), */ 
                   /*               mMaterial_cp[gr](1, i0, j0, k0), mMaterial_cp[gr](1, i0, j0, k0-1)); */
                   /*   else */
                   /*       printf("Rank %d: Grid %d, (%d, %d, %d) z = %.2f, goes to patch %d (%d, %d, %d) z = %.2f, p = %.2f, mat_p = %.2f\n", */ 
                   /*               mEW->getRank(), g, i, j, k, z, gr, i0, j0, k0, tmp_z, cp[g](i, j, k), mMaterial_cp[gr](1, i0, j0, k0)); */
                   /* } */
    ...
    /*       if (rho[g](gi,gj,gk) < 0) { */
    /*         int tmp = gk + 1; */
    /*         while (rho[g](gi,gj,tmp) < 0) { tmp++; } */
    /*         printf("Error with grid %d rho(%d, %d, %d): %.2f, changing to %.2f\n", g, gi, gj, gk, rho[g](gi,gj,gk), rho[g](gi,gj,tmp)); */
    /*         rho[g](gi,gj,gk) = rho[g](gi,gj,tmp); */
    /*       } */
    /*       if (cp[g](gi,gj,gk) < 0) { */
    /*         int tmp = gk + 1; */
    /*         while (cp[g](gi,gj,tmp) < 0) { tmp++; } */
    /*         printf("Error with grid %d cp(%d, %d, %d): %.2f, changing to %.2f\n", g, gi, gj, gk, cp[g](gi,gj,gk), cp[g](gi,gj,tmp)); */
    /*         cp[g](gi,gj,gk) = cp[g](gi,gj,tmp); */
    /*       } */
    /*       if (cs[g](gi,gj,gk) < 0) { */
    /*         int tmp = gk + 1; */
    /*         while (cs[g](gi,gj,tmp) < 0) { tmp++; } */
    /*         printf("Error with grid %d cs(%d, %d, %d): %.2f, changing to %.2f\n", g, gi, gj, gk, cs[g](gi,gj,gk), cs[g](gi,gj,tmp)); */
    /*         cs[g](gi,gj,gk) = cs[g](gi,gj,tmp); */
    /*       } */
    /*       if( use_q ) { */
    /*         if (xip[g](gi,gj,gk) < 0) { */
    /*           int tmp = gk + 1; */
    /*           while (xip[g](gi,gj,tmp) < 0) { tmp++; } */
    /*           printf("Error with grid %d xip(%d, %d, %d): %.2f, changing to %.2f\n", g, gi, gj, gk, xip[g](gi,gj,gk), xip[g](gi,gj,tmp)); */
    /*           xip[g](gi,gj,gk) = xip[g](gi,gj,tmp); */
    /*         } */
    /*         if (xis[g](gi,gj,gk) < 0) { */
    /*           int tmp = gk + 1; */
    /*           while (xis[g](gi,gj,tmp) < 0) { tmp++; } */
    /*           printf("Error with grid %d xis(%d, %d, %d): %.2f, changing to %.2f\n", g, gi, gj, gk, xis[g](gi,gj,gk), xis[g](gi,gj,tmp)); */
    /*           xis[g](gi,gj,gk) = xis[g](gi,gj,tmp); */
    /*         } */
    /*       } */
    /*     } */
    /*   } */
...
//test
  ...
  /*         if ( mMaterial_cs[p](1,i,j,k) < 0 || mMaterial_cp[p](1,i,j,k) < 0 || mMaterial_rho[p](1,i,j,k) < 0) { */
  /*           printf("Rank %d, patch %d, (%d, %d, %d) cs = %.2f, cp = %.2f, rho = %.2f\n", */
  /*                   mEW->getRank(), p, i,j,k, mMaterial_cs[p](1,i,j,k), mMaterial_cp[p](1,i,j,k), mMaterial_rho[p](1,i,j,k)); */
  /*         } */
  /*         if (m_use_attenuation) { */
  /*           if ( mMaterial_qp[p](1,i,j,k) < 0 || mMaterial_qs[p](1,i,j,k) < 0) { */
  /*             printf("Rank %d, patch %d, (%d, %d, %d) qs = %.2f, qp = %.2f\n", */
  /*                   mEW->getRank(), p,i,j,k, mMaterial_qs[p](1,i,j,k), mMaterial_qp[p](1,i,j,k)); */
  /*           } */
  /*         } */
  /*       } */
  /*     } */
